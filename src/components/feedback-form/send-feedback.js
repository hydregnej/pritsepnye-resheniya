...
async function sendEmailToServer(event) {
  ...
  try {
    ...
    console.error(error);
    formSendResult.textContent = 'Произошла ошибка. Обращение не было отправлено. Пожалуйста, проверьте корректность введённых данных или обновите страницу и заполните информацию повторно. Если проблема не решится, свяжитесь с нами по телефону 8 800 505-13-23 или напишите в WhatsApp/Telegram.';
